...
@interface AkimboUITableViewController ()

@end

@implementation AkimboUITableViewController
...
{
    //Get the section
    AkimboUITableViewControllerSection *section = [self getSectionFromIndexPath:indexPath];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    if (section < sections.count) {
        AkimboUITableViewControllerSection *tableSection = [sections objectAtIndex:section];
